...
namespace IndustryConnect.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TMFeature", "As a Turn Up portal admin, \r\nI would like to create and edit time and material re" +
                    "cords.\r\nSo that I can manage the employees\' time and material successfully.", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Time", "Whatever", "7", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "Bags", "1678", null)]
        [NUnit.Framework.TestCaseAttribute("EditedRecord", "SomethingElse", "1.238", null)]
...
#line hidden
#line 16
 testRunner.And(string.Format("I update \'{0}\', \'{1}\' and \'{2}\' and edit an existing time and material record", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 17
